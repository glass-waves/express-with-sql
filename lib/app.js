...
app.post('/modules', async (req, res) => {
    ...
    try {
        ...
        const data = await client.query(
            ...
            RETURNING *`,[req.body._id, req.body.brand, req.body.module_name, req.body.image, categoryId, req.body.size, req.body.description, req.body.price, req.body.in_stock, 1]);
