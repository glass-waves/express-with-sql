...
app.put('/modules/single/:id', async (req, res) => {
    try {
        ...
        const data = await client.query(`
            ...
            WHERE id=$10
            RETURNING *`,[req.body.brand, req.body.module_name, req.body.image, req.body.category_id, req.body.size, req.body.description, req.body.price, req.body.in_stock, 1, moduleId] );
